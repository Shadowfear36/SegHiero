...
- **Fine level**: very granular classes (e.g. "Scratch", "Dent", "Crack", "Discoloration", …)  
- **Coarse level**: higher‐level buckets grouping those fine labels (e.g. all surface defects grouped under "Surface‐Defect")  
- **Super / Ultra‐coarse level** (optional): group multiple coarse categories (e.g. "Surface‐Defect" + "Structural‐Defect" under "Product‐Defect" vs. "Foreign Material")
