...
class TreeTripletLoss(nn.Module):
    def __init__(self, num_classes, hiera_map, hiera_index, ignore_index=255, margin=0.6, max_samples=200):
    ...
    def forward(self, feats, labels=None, max_triplet=None):
...
#             label_neg = labels[index_neg][:min_size]
            ...
            distance = torch.zeros(min_size, 2, device=device)
